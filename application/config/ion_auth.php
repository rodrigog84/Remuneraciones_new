...
$config['tables']['app']  = 'rem_app';
$config['tables']['menu']  = 'rem_menu';
 ...
 */
$config['site_title']                 = "Tu Gasto Comun";       // Site Title, example.com
$config['admin_email']                = "contacto@tugastocomun.cl"; // Admin Email, admin@example.com
