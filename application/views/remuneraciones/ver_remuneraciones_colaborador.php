<!--sub-heard-part-->
									  <div class="sub-heard-part">
									   <ol class="breadcrumb m-b-0">
											...
											<li class="active">Ver Remuneraciones</li>
																	...
																	<tbody> 
												                        ...
												                        <?php foreach ($remuneraciones as $remuneracion) { ?>
												                         <tr >
												                          ...
												                          <td><center><a href="<?php echo base_url(); ?>rrhh/liquidacion_colaborador/<?php echo $remuneracion->id_remuneracion;?>" target="_blank"><span class="glyphicon glyphicon-paperclip"></span></a></center></td>
