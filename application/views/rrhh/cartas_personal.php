<!--sub-heard-part-->
									  <div class="sub-heard-part">
									   		<ol class="breadcrumb m-b-0">
												...
												<li class="active">Cartas Colaborador</li>
											</ol>
									   </div>
								  <!--//sub-heard-part-->
								...
								<td>			
								<a href="<?php echo base_url();?>rrhh/carta_colaborador/<?php echo $trabajador->id_personal?>" class="btn btn-info opciones" id="opciones" title="Cartas"><i class="fa fa-pencil-square-o" aria-hidden="true" role="button"></i></a>						
								</td>
								</tr> 
