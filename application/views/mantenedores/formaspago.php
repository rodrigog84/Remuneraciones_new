/<!--sub-heard-part-->
                          ...
                          <a href="<?php echo base_url();?>exportarmantenedores/exportarExcelFormaPago" class = "btn btn-primary" type="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i>Exporta Excel</a>
                          <h3 class="inner-tittle two">Descripción</h3>
                                        ...
                                        <th>Opciones</th>
	                              		...
	                              		<td><small><h4 class="inner-tittle two"><?php echo $formadepago->descripcion;?></small></h4></td>
                                    <td>
                                    <a href="<?php echo base_url();?>mantenedores/add_formasdepago/<?php echo $formadepago->id_forma_pago?>" class="btn btn-info opciones" id="opciones" title="Editar Formas de Pago"><i class="fa fa-pencil-square-o" aria-hidden="true" role="button"></i></a>
