/<!--sub-heard-part-->
                          ...
                          <h3 class="inner-tittle two">Descripción</h3>
                                        ...
                                        <th>Opciones</th>
	                              		...
	                              		<td><small><h4 class="inner-tittle two"><?php echo $estadocivil->nombre;?></small></h4></td>
                                    <td>
                                    <a href="<?php echo base_url();?>mantenedores/add_estadocivil/<?php echo $estadocivil->id_estado_civil?>" class="btn btn-info opciones" id="opciones" title="Editar Estado Civil"><i class="fa fa-pencil-square-o" aria-hidden="true" role="button"></i></a>
              ...
              <form action="<?php echo base_url();?>mantenedores/delete_estado_civil/" method="GET">
                  ...
                  <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <br>
                          <a href="<?php echo base_url();?>mantenedores/delete_estadocivil/<?php echo $estadocivil->id_estado_civil;?>" type="button" class="btn btn-info"><span><i class="fa fa-trash-o" aria-hidden="true"></i></span> Eliminar</a>
