/<!--sub-heard-part-->
								  <!--//sub-heard-part-->
									...
									<div class="graph-visual tables-main">
													...
													<a href="<?php echo base_url();?>mantenedores/add_bancos" type="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i>Nuevo Banco</a>
                         <a href="<?php echo base_url();?>exportarmantenedores/exportarExcelbancos" class = "btn btn-primary" type="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i>Exporta Excel</a>
              ...
              <form action="<?php echo base_url();?>mantenedores/delete_bancos/" method="GET">
                  ...
                  <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <br>
                          <a href="<?php echo base_url();?>mantenedores/delete_bancos/<?php echo $bancos->id_banco;?>" type="button" class="btn btn-info"><span><i class="fa fa-trash-o" aria-hidden="true"></i></span> Eliminar</a>
