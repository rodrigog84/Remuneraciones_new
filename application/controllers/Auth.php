...
class Auth extends CI_Controller {
	...
	function login()
	{
		...
		if ($this->ion_auth->logged_in()){ //si está logueado, lo envía al home
			redirect('/', 'refresh');
		}
	...
	function logout()
	{
		...
		//$idlog = $this->ion_auth->log('logout'); //genera log de acceso
		//redirect them to the login page
	...
	/*function add_user()
	{
		...
		if($this->ion_auth->is_allowed($this->router->fetch_class(),$this->router->fetch_method())){
				...
				else
				{
					...
					$vars['first_name'] = array(
						'name'  => 'first_name',
						'id'    => 'first_name',
						'type'  => 'text',
						'value' => $this->form_validation->set_value('first_name'),
					);
					$vars['last_name'] = array(
						'name'  => 'last_name',
						'id'    => 'last_name',
						'type'  => 'text',
					...
					$vars['content_view'] = 'auth/add_user';
